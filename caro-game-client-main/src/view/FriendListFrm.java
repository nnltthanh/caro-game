 ...
 * @author Admin
 */
public class FriendListFrm extends PlayerView {
    private List<Player> listFriend;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Player friend = listFriend.get(jTable1.getSelectedRow());
            if(!friend.getIsOnline()){
