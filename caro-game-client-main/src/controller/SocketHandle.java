...
public class SocketHandle implements Runnable {
    ...
    public List<Player> getListUser(String[] message){
        List<Player> friend = new ArrayList<>();
        for(int i=1; i<message.length; i=i+4){
            friend.add(new Player(Integer.parseInt(message[i]),
                    message[i+1],
        ...
        try {
            ...
            while (true) {
                ...
                if(messageSplit[0].equals("login-success")){
                    ...
                    Player user= getUserFromString(1,messageSplit);
                    Client.user = user;
                ...
                if(messageSplit[0].equals("draw-game")){
                    ...
                    Thread.sleep(4000);
                    Client.gameClientFrm.updateNumberOfGame();
//                    Client.gameClientFrm.updateNumberOfDraw();
                    Client.closeView(Client.View.GAMENOTICE);
                    Client.gameClientFrm.newgame();
                }
